...
namespace Movie_website.Models
{
    ...
    public class FilmDataInitialiser : DropCreateDatabaseAlways<FilmContext>
    {
        protected override void Seed(FilmContext context)
        {
            ...
            film7.FilmId = 7;
            //film6.ReivewId = 6;
            film7.FilmName = "Brightburn ";
            film7.Description = "What if a child from another world crash-landed on Earth, but instead of becominga hero to mankind, he proved to be something far more sinister?.";
            film7.Language = "English";
            film7.DateReleased = new DateTime(2019, 1, 21);
            film7.Genre = "Drama";
            film7.Image = "7.jpg";
            //film6.Reivew = rev6;
            ...
            MovieStar s2 = new MovieStar();
            s2.Name = "Mckenna Grace";
            s2.Image = "Mckenna Grace.jpg";
            s2.IsActor = true;
            s2.IsDirector = false;
            context.MovieStar.Add(s2);
            MovieStar s3 = new MovieStar();
            s3.Name = "Patrick Wilson";
            s3.Image = "Patrick Wilson.jpg";
            s3.IsActor = true;
            s3.IsDirector = false;
            context.MovieStar.Add(s3);
            MovieStar s4 = new MovieStar();
            s4.Name = "Steve Coulter";
            s4.Image = "Steve Coulter.jpg";
            s4.IsActor = true;
            s4.IsDirector = false;
            context.MovieStar.Add(s4);
            MovieStar s5 = new MovieStar();
            s5.Name = "Vera Farmiga";
            s5.Image = "Vera Farmiga.jpg";
            s5.IsActor = true;
            s5.IsDirector = false;
            context.MovieStar.Add(s5);
            MovieStar s6 = new MovieStar();
            s6.Name = "Mike Moh";
            s6.Image = "Mike Moh.jpg";
            s6.IsActor = false;
            s6.IsDirector = true;
            context.MovieStar.Add(s6);
            MovieStar s7 = new MovieStar();
            s7.Name = "Luke Perry";
            s7.Image = "Luke Perry.jpg";
            s7.IsActor = false;
            s7.IsDirector = true;
            context.MovieStar.Add(s7);
            MovieStar s8 = new MovieStar();
            s8.Name = "Jason Clarke";
            s8.Image = "Jason Clarke.jpg";
            s8.IsActor = false;
            s8.IsDirector = true;
            context.MovieStar.Add(s8);
